...
namespace MathSharp.UnitTests.VectorTests.VectorDouble.VectorOperations
{
    public class DistanceSquared
    {
                    ...
                    case VectorDimensions.V2D:
                        {
                            ...
                            double dot = Vector2d.DistanceSquared(v1, v2);
                    ...
                    case VectorDimensions.V3D:
                        {
                            ...
                            double dot = Vector3d.DistanceSquared(v1, v2);
                    ...
                    case VectorDimensions.V4D:
                        {
                            ...
                            double dot = (v1 - v2).LengthSquared;
        ...
        public static void DistanceSquared3D_Theory(Vector256<double> left, Vector256<double> right, Vector3d expected)
        {
            Vector256<double> result = Vector.DistanceSquared3D(left, right);
        ...
        public static void DistanceSquared4D_Theory(Vector256<double> left, Vector256<double> right, Vector4d expected)
        {
            Vector256<double> result = Vector.DistanceSquared4D(left, right);
