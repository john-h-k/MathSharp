...
namespace MathSharp.UnitTests.VectorTests.VectorDouble.VectorOperations
{
    public class Distance
    {
                    ...
                    case VectorDimensions.V2D:
                        {
                            ...
                            double dot = Vector2d.Distance(v1, v2);
                    ...
                    case VectorDimensions.V3D:
                        {
                            ...
                            double dot = Vector3d.Distance(v1, v2);
        ...
        public static void Distance2D_Theory(Vector256<double> left, Vector256<double> right, Vector2d expected)
        {
            Vector256<double> result = Vector.Distance2D(left, right);
        ...
        public static void Distance3D_Theory(Vector256<double> left, Vector256<double> right, Vector3d expected)
        {
            Vector256<double> result = Vector.Distance3D(left, right);
        ...
        public static void Distance4D_Theory(Vector256<double> left, Vector256<double> right, Vector4d expected)
        {
            Vector256<double> result = Vector.Distance4D(left, right);
