...
namespace MathSharp.UnitTests.VectorTests.VectorSingle.ConversionTests
{
    public class LoadTests
    {
        ...
        //    Assert.True(TestHelpers.AreEqual(vector, loaded));
        //}
        ...
        //    Assert.True(TestHelpers.AreEqual(new Vector4(vector, scalar), loaded));
        //}
        ...
        //    Assert.True(TestHelpers.AreEqual(new Vector4(vector, vector.X, vector.Y), loaded));
        //}
        ...
        //    Assert.True(TestHelpers.AreEqual(new Vector4(vector), loaded));
        //}
    }
}