...
namespace MathSharp.UnitTests.VectorTests.VectorSingle.VectorOperations
{
    public class Distance
    {
                    ...
                    case VectorDimensions.V2D:
                        {
                            ...
                            float dot = Vector2.Distance(v1, v2);
                    ...
                    case VectorDimensions.V3D:
                        {
                            ...
                            float dot = Vector3.Distance(v1, v2);
                    ...
                    case VectorDimensions.V4D:
                        {
                            ...
                            float dot = Vector4.Distance(v1, v2);
        ...
        public static void Distance2D_Theory(Vector128<float> left, Vector128<float> right, Vector2 expected)
        {
            Vector128<float> result = Vector.Distance2D(left, right);
        ...
        public static void Distance3D_Theory(Vector128<float> left, Vector128<float> right, Vector3 expected)
        {
            Vector128<float> result = Vector.Distance3D(left, right);
        ...
        public static void Distance4D_Theory(Vector128<float> left, Vector128<float> right, Vector4 expected)
        {
            Vector128<float> result = Vector.Distance4D(left, right);
