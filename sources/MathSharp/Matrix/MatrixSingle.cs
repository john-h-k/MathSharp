...
namespace MathSharp
{
    ...
    {
        public HwVector4S _v0;
        public HwVector4S _v1;
        public HwVector4S _v2;
        public HwVector4S _v3;
        ...
        {
            get => Unsafe.Add(ref Unsafe.As<HwVector4S, float>(ref _v0), (int)(x * 4 + y));

            set => Unsafe.Add(ref Unsafe.As<HwVector4S, float>(ref _v0), (int)(x * 4 + y)) = value;
        }
