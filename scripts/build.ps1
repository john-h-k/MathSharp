...
try {
  ...
  if ($architecture -ne "") {
    ...
    Create-Directory -Path $DotNetInstallDirectory
     ...
     & $DotNetInstallScript -Channel preview -InstallDir $DotNetInstallDirectory -Architecture $architecture
    & $DotNetInstallScript -Channel preview -InstallDir $DotNetInstallDirectory  -Architecture $architecture -Runtime dotnet
