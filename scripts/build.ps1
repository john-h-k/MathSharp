...
try {
  ...
  if ($architecture -ne "") {
    ...
    & $DotNetInstallScript -Channel release/3.0.0-preview5 -Version latest -InstallDir $DotNetInstallDirectory -Architecture $architecture
    & $DotNetInstallScript -Channel release/3.0.0-preview5 -Version latest -InstallDir $DotNetInstallDirectory  -Architecture $architecture -Runtime dotnet
